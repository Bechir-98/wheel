        ...
        <div>
          ...
          <div className='how'>
            ...
            <div className='ph'>
              ...
              <h2>Clinician</h2>
              <h3>Adds medical information</h3>
            </div>
            <img src={ff} alt="Process step" />
            <div className='ph'>
              <img src={vendor} alt="Vendor" />
              <h2>Vendor</h2>
              <h3>Finalizes and plans trial</h3>
            </div>
          </div>
        </div>
          ...
          <div className='card-container'>
            ...
            <ReactCardFlip isFlipped={isFlippedP} flipDirection="horizontal">
              ...
              <div className='card back' onClick={() => setIsFlippedP(false)}>
                <p>
                  Find the wheelchair that best suits your physical condition, lifestyle, and preferences.
            ...
            <ReactCardFlip isFlipped={isFlippedC} flipDirection="horizontal">
              ...
              <div className='card back' onClick={() => setIsFlippedC(false)}>
                <p>
                  Help patients by providing medical information and mobility assessments.
                  Collaborate in the recommendation process to ensure accurate fitting.
                </p>
              </div>
            </ReactCardFlip>
            ...
            <ReactCardFlip isFlipped={isFlippedV} flipDirection="horizontal">
              ...
              <div className='card back' onClick={() => setIsFlippedV(false)}>
                <p>
                  ...
                  Schedule product trials, manage logistics, and offer customized wheelchair solutions.
                </p>
              </div>
            </ReactCardFlip>
          </div>
